...
You might argue that the comparison is still unfair. More women than men --- even with graduate degrees --- 
...
1. Look in the **options** tab to select what attributes to collect.
<<<<<<< HEAD
...
=======
2.  Check under **Basic interesting stuff** and check **Education**
1.  Check udner **Work and employment** and check **EmplStatus** (employment status)
1.  Check other attributes you might be interested in
>>>>>>> 53e6f2abad1cd9f3677e129232f564303963aebf
1.  Edit the "10" cases to be "1000" and click **Get 1000 people**
1.  To save space, you may want to minimiize the portal itself (labeled ACS) by clicking the minus sign at its upper right.

From before, you know how to filter and make graphs and compute summaries such as the median. See if you can figure out how to select only the employed people and exclude everybody else, then compare males and females (or any other groups) to compare their incomes. 

<<<<<<< HEAD
If you want more screen space, do this exploration in a separate browser window (instead of in the context of this blog post): [Use this link](https://codap.concord.org/releases/latest/static/dg/en/cert/index.html#shared=108852).
=======
And if you want to do that in a separate browser window (instead of in the context of this blog post), [use this link](https://codap.concord.org/releases/latest/static/dg/en/cert/index.html#shared=108852).
>>>>>>> 53e6f2abad1cd9f3677e129232f564303963aebf
